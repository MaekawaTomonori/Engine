...
/// シングルトンインスタンス
///=====================================================///
AudioAnther* AudioAnther::GetInstance() {
	static AudioAnther instance;
	return &instance;
}
...
/// 音声データの読み込み
///=====================================================///
SoundData AudioAnther::SoundLoad(const char* fileName) {
...
/// 音声データの解放
///=====================================================///
void AudioAnther::SoundUnLoad(SoundData* soundData) {
...
/// 音声オブジェクトの生成
///=====================================================///
SoundObject AudioAnther::CreateSoundObject(SoundData soundData, bool isLoop) {
...
/// 音声の再生
///=====================================================///
void AudioAnther::StartSound(SoundObject object) {
...
/// 音声の停止
///=====================================================///
void AudioAnther::StopSound(SoundObject object) {
...
/// 音声が流れているか
///=====================================================///
bool AudioAnther::isPlayed(SoundObject object) {
